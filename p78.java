...
public class p78 {
    ...
    public static void main(String[] args) {
        ...
        int getNthParts = 1000000; //enter what number you want the partitions of, preferably less than 1mil
        ...
        for (int n = 2; n <= ceiling; n++) {
            ...
            if(partitions.mod(BigInteger.valueOf(1000000)).compareTo(BigInteger.ZERO) == 0){
                
                System.out.println(n - 1 + " is the first number with partitions congruent to 1 million.");
                System.exit(0);
            }
