...
public class p54 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < values.size(); i += 10) {
            ...
            handOnevalues.add(values.get(i));
            handOnevalues.add(values.get(i + 1));
            handOnevalues.add(values.get(i + 2));
            handOnevalues.add(values.get(i + 3));
            handOnevalues.add(values.get(i + 4));
            handOnesuits.add(suits.get(i));
            handOnesuits.add(suits.get(i + 1));
            handOnesuits.add(suits.get(i + 2));
            handOnesuits.add(suits.get(i + 3));
            handOnesuits.add(suits.get(i + 4));
        }

        for (int i = 5; i < values.size(); i += 10) {

            handTwovalues.add(values.get(i));
            handTwovalues.add(values.get(i + 1));
            handTwovalues.add(values.get(i + 2));
            handTwovalues.add(values.get(i + 3));
            handTwovalues.add(values.get(i + 4));
            handTwosuits.add(suits.get(i));
            handTwosuits.add(suits.get(i + 1));
            handTwosuits.add(suits.get(i + 2));
            handTwosuits.add(suits.get(i + 3));
            handTwosuits.add(suits.get(i + 4));
        }
        ...
        while (i < 5000) {
            ...
            tempOnevalue.add(handOnevalues.get(i));
            tempOnevalue.add(handOnevalues.get(i + 1));
            tempOnevalue.add(handOnevalues.get(i + 2));
            tempOnevalue.add(handOnevalues.get(i + 3));
            tempOnevalue.add(handOnevalues.get(i + 4));
            tempOnesuit.add(handOnesuits.get(i));
            tempOnesuit.add(handOnesuits.get(i + 1));
            tempOnesuit.add(handOnesuits.get(i + 2));
            tempOnesuit.add(handOnesuits.get(i + 3));
            tempOnesuit.add(handOnesuits.get(i + 4));
            tempTwovalue.add(handTwovalues.get(i));
            tempTwovalue.add(handTwovalues.get(i + 1));
            tempTwovalue.add(handTwovalues.get(i + 2));
            tempTwovalue.add(handTwovalues.get(i + 3));
            tempTwovalue.add(handTwovalues.get(i + 4));
            tempTwosuit.add(handTwosuits.get(i));
            tempTwosuit.add(handTwosuits.get(i + 1));
            tempTwosuit.add(handTwosuits.get(i + 2));
            tempTwosuit.add(handTwosuits.get(i + 3));
            tempTwosuit.add(handTwosuits.get(i + 4));

            Collections.replaceAll(tempOnevalue, "T", "10");
            Collections.replaceAll(tempOnevalue, "J", "11");
            Collections.replaceAll(tempOnevalue, "Q", "12");
            Collections.replaceAll(tempOnevalue, "K", "13");
            Collections.replaceAll(tempOnevalue, "A", "14");
            Collections.replaceAll(tempTwovalue, "T", "10");
            Collections.replaceAll(tempTwovalue, "J", "11");
            Collections.replaceAll(tempTwovalue, "Q", "12");
            Collections.replaceAll(tempTwovalue, "K", "13");
            Collections.replaceAll(tempTwovalue, "A", "14");
            List<Integer> onelist = tempOnevalue.stream().map(s -> Integer.parseInt(s)).collect(Collectors.toList());
            Collections.sort(onelist);
            List<Integer> twolist = tempTwovalue.stream().map(s -> Integer.parseInt(s)).collect(Collectors.toList());
            Collections.sort(twolist);

            if (value(tempOnevalue, tempOnesuit) > value(tempTwovalue, tempTwosuit)) {
            ...
            if (value(tempOnevalue, tempOnesuit) == value(tempTwovalue, tempTwosuit)) {
                ...
                //9 is straight flush
                if (value(tempOnevalue, tempOnesuit) == 9) {

                    if (onelist.get(4) > twolist.get(4)) {
                ...
                //8 is four of a kind
                if (value(tempOnevalue, tempOnesuit) == 8) {

                    if (onelist.get(2) > twolist.get(2)) {
                ...
                //7 is full house
                if (value(tempOnevalue, tempOnesuit) == 7) {
                ...
                //6 is flush
                if (value(tempOnevalue, tempOnesuit) == 6) {
                ...
                //5 is straight
                if (value(tempOnevalue, tempOnesuit) == 5) {
                ...
                if (value(tempOnevalue, tempOnesuit) == 4) {
                ...
                //3 is two pairs
                if (value(tempOnevalue, tempOnesuit) == 3) {

                    if (onelist.get(3) > twolist.get(3)) {
                    ...
                    if (onelist.get(3) == twolist.get(3)) {
                        ...
                        if (onelist.get(1) > twolist.get(1)) {
                        ...
                        if (onelist.get(1) == twolist.get(1)) {
                            ...
                            if (Collections.frequency(onelist, onelist.get(4)) == 1 && Collections.frequency(twolist, twolist.get(4)) == 1) {
                            ...
                            if (Collections.frequency(onelist, onelist.get(4)) == 1 && Collections.frequency(twolist, twolist.get(2)) == 1) {

                                if (onelist.get(4) > twolist.get(2)) {

                                    wins++;
                                }
                            }

                            if (Collections.frequency(onelist, onelist.get(4)) == 1 && Collections.frequency(twolist, twolist.get(0)) == 1) {

                                if (onelist.get(4) > twolist.get(0)) {

                                    wins++;
                                }
                            }

                            if (Collections.frequency(onelist, onelist.get(2)) == 1 && Collections.frequency(twolist, twolist.get(4)) == 1) {

                                if (onelist.get(2) > twolist.get(4)) {

                                    wins++;
                                }
                            }

                            if (Collections.frequency(onelist, onelist.get(2)) == 1 && Collections.frequency(twolist, twolist.get(2)) == 1) {
                            ...
                            if (Collections.frequency(onelist, onelist.get(2)) == 1 && Collections.frequency(twolist, twolist.get(0)) == 1) {

                                if (onelist.get(2) > twolist.get(0)) {

                                    wins++;
                                }
                            }

                            if (Collections.frequency(onelist, onelist.get(0)) == 1 && Collections.frequency(twolist, twolist.get(4)) == 1) {

                                if (onelist.get(0) > twolist.get(4)) {

                                    wins++;
                                }
                            }

                            if (Collections.frequency(onelist, onelist.get(0)) == 1 && Collections.frequency(twolist, twolist.get(2)) == 1) {

                                if (onelist.get(0) > twolist.get(2)) {

                                    wins++;
                                }
                            }

                            if (Collections.frequency(onelist, onelist.get(0)) == 1 && Collections.frequency(twolist, twolist.get(0)) == 1) {

                                if (onelist.get(0) > twolist.get(0)) {
                ...
                //2 is a pair
                if (value(tempOnevalue, tempOnesuit) == 2) {

                    if (Collections.frequency(onelist, onelist.get(0)) == 2 && Collections.frequency(onelist, onelist.get(1)) == 2) {

                        if (Collections.frequency(twolist, twolist.get(0)) == 2 && Collections.frequency(twolist, twolist.get(1)) == 2) {
                        ...
                        if (Collections.frequency(twolist, twolist.get(1)) == 2 && Collections.frequency(twolist, twolist.get(2)) == 2) {

                            if (onelist.get(0) > twolist.get(1)) {
                        ...
                        if (Collections.frequency(twolist, twolist.get(2)) == 2 && Collections.frequency(twolist, twolist.get(3)) == 2) {
                        ...
                        if (Collections.frequency(twolist, twolist.get(3)) == 2 && Collections.frequency(twolist, twolist.get(4)) == 2) {

                            if (onelist.get(0) > twolist.get(3)) {
                    ...
                    if (Collections.frequency(onelist, onelist.get(1)) == 2 && Collections.frequency(onelist, onelist.get(2)) == 2) {

                        if (Collections.frequency(twolist, twolist.get(0)) == 2 && Collections.frequency(twolist, twolist.get(1)) == 2) {

                            if (onelist.get(1) > twolist.get(0)) {
                        ...
                        if (Collections.frequency(twolist, twolist.get(2)) == 2 && Collections.frequency(twolist, twolist.get(3)) == 2) {
                            ...
                            if (onelist.get(1) > twolist.get(2)) {
                        ...
                        if (Collections.frequency(twolist, twolist.get(3)) == 2 && Collections.frequency(twolist, twolist.get(4)) == 2) {
                            ...
                            if (onelist.get(1) > twolist.get(3)) {
                    ...
                    if (Collections.frequency(onelist, onelist.get(2)) == 2 && Collections.frequency(onelist, onelist.get(3)) == 2) {
                        ...
                        if (Collections.frequency(twolist, twolist.get(1)) == 2 && Collections.frequency(twolist, twolist.get(2)) == 2) {
                            ...
                            if (onelist.get(2) > twolist.get(1)) {
                        ...
                        if (Collections.frequency(twolist, twolist.get(3)) == 2 && Collections.frequency(twolist, twolist.get(4)) == 2) {
                            ...
                            if (onelist.get(2) > twolist.get(3)) {
                    ...
                    if (Collections.frequency(onelist, onelist.get(3)) == 2 && Collections.frequency(onelist, onelist.get(4)) == 2) {

                        if (Collections.frequency(twolist, twolist.get(0)) == 2 && Collections.frequency(twolist, twolist.get(1)) == 2) {

                            if (onelist.get(3) > twolist.get(0)) {
                        ...
                        if (Collections.frequency(twolist, twolist.get(1)) == 2 && Collections.frequency(twolist, twolist.get(2)) == 2) {
                            ...
                            if (onelist.get(3) > twolist.get(1)) {
                        ...
                        if (Collections.frequency(twolist, twolist.get(2)) == 2 && Collections.frequency(twolist, twolist.get(3)) == 2) {
                            ...
                            if (onelist.get(3) > twolist.get(2)) {
                ...
                //1 is nothing but highest card
                if (value(tempOnevalue, tempOnesuit) == 1) {
    ...
    public static int value(ArrayList<String> value, ArrayList<String> suit) {

        if (royalFlush(value, suit)) {

            return 10;
        }

        if (straightFlush(value, suit)) {
    ...
    public static boolean royalFlush(ArrayList<String> value, ArrayList<String> suit) {

        Collections.replaceAll(value, "T", "10");
        Collections.replaceAll(value, "J", "11");
        Collections.replaceAll(value, "Q", "12");
        Collections.replaceAll(value, "K", "13");
        Collections.replaceAll(value, "A", "14");

        if (value.contains("10") && value.contains("11") && value.contains("12") && value.contains("13") && value.contains("14") && Collections.frequency(suit, suit.get(0)) == 5) {
    ...
    public static boolean straightFlush(ArrayList<String> value, ArrayList<String> suit) {
        ...
        Collections.replaceAll(value, "K", "13");
        Collections.replaceAll(value, "A", "14");
        List<Integer> list = value.stream().map(s -> Integer.parseInt(s)).collect(Collectors.toList());
        Collections.sort(list);

        if (Collections.frequency(suit, suit.get(0)) == 5 && list.contains(list.get(0) + 1) && list.contains(list.get(0) + 2) && list.contains(list.get(0) + 3) && list.contains(list.get(0) + 4)) {
    ...
    public static boolean four(ArrayList<String> value, ArrayList<String> suit) {
        ...
        if (Collections.frequency(value, value.get(1)) == 4) {
    ...
    public static boolean fullHouse(ArrayList<String> value, ArrayList<String> suit) {
        ...
        if (Collections.frequency(list, list.get(2)) == 3) {

            if (Collections.frequency(list, list.get(0)) == 2) {

                return true;
            }

            if (Collections.frequency(list, list.get(4)) == 2) {
    ...
    public static boolean flush(ArrayList<String> value, ArrayList<String> suit) {

        if (Collections.frequency(suit, suit.get(0)) == 5) {
    ...
    public static boolean straight(ArrayList<String> value, ArrayList<String> suit) {
        ...
        if (list.contains(list.get(0) + 1) && list.contains(list.get(0) + 2) && list.contains(list.get(0) + 3) && list.contains(list.get(0) + 4)) {
    ...
    public static boolean three(ArrayList<String> value, ArrayList<String> suit) {
    ...
    public static boolean twoPair(ArrayList<String> value, ArrayList<String> suit) {
        ...
        if (Collections.frequency(list, list.get(1)) == 2 && Collections.frequency(list, list.get(3)) == 2) {
    ...
    public static boolean pair(ArrayList<String> value, ArrayList<String> suit) {
        ...
        if (Collections.frequency(list, list.get(0)) == 2 || Collections.frequency(list, list.get(1)) == 2 || Collections.frequency(list, list.get(2)) == 2 || Collections.frequency(list, list.get(3)) == 2 || Collections.frequency(list, list.get(4)) == 2) {
